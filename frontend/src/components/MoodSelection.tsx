...
const MOODS = [
{
  id: 'cry',
  name: 'Want to cry',
  desc: 'Tearjerkers & emotional dramas',
  icon: HeartCrack,
...
},
{
  id: 'laugh',
  name: 'Need to laugh',
  desc: 'Comedies that lift the mood',
  icon: Smile,
  color: 'bg-amber-100 text-amber-600'
},
{
  id: 'edge',
  name: 'Edge of my seat',
  desc: 'Thrillers & nail-biters',
  icon: Swords,
  color: 'bg-blue-100 text-blue-600'
},
{
  id: 'brain-off',
  name: 'Turn my brain off',
  desc: 'Easy, fun popcorn flicks',
  icon: Popcorn,
...
},
{
  id: 'love',
  name: 'Fall in love',
  desc: 'Romance & cozy nights',
  icon: Heart,
  color: 'bg-rose-100 text-rose-600'
},
{
  id: 'journey',
  name: 'Go on a journey',
  desc: 'Epic adventures & worlds',
  icon: Map,
        ...
        {MOODS.map((mood) => {
          ...
          return (
            <button
              ...
              <div
                className={`w-10 h-10 rounded-full flex items-center justify-center mb-4 ${mood.color}`}>
