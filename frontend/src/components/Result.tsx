...
const MOVIES: Movie[] = [
{
  ...
  story:
  'In a future where humanity lives among the stars, a lone explorer discovers a signal from a forgotten era that challenges everything they know about their origin and destiny. A visual masterpiece exploring the silence of the cosmos.',
  director: 'Elena Vance',
  cinematography: 'M. Arisawa',
  cast: [
  {
    name: 'Cillian Ross',
    role: 'Jax'
  ...
  genre: 'Sci-Fi, Drama',
  studio: 'Astra Pictures',
  language: 'English',
  status: 'Trending #1',
  moodMatch:
  'Matches your mood for a journey and the cinematic feel of recent favorites like Interstellar.'
},
{
  ...
  story:
  'A weathered lighthouse keeper and a runaway artist forge an unlikely friendship over one luminous summer. A tender, slow-burning story about second chances and the courage to begin again.',
  director: 'Marco Ferreira',
  cinematography: 'Lena Okafor',
  cast: [
  {
    name: 'Iris Hale',
    role: 'Mara'
  ...
  genre: 'Drama, Romance',
  studio: 'Lantern Films',
  language: 'English',
  status: 'Critically Acclaimed',
  moodMatch:
  'A warm, character-driven pick for when you want something heartfelt and unhurried tonight.'
},
{
  title: 'Neon Verdict',
  rating: '8.1',
  ...
  story:
  'A burnt-out detective races against a 24-hour deadline through a rain-soaked city to clear her partner of a crime he didn\u2019t commit. A relentless, neon-lit thriller that never lets up.',
  director: 'Dahlia Cross',
  cinematography: 'R. Solberg',
  cast: [
  {
    name: 'June Park',
    role: 'Det. Reyes'
  ...
  studio: 'Midnight Reel',
  language: 'English',
  status: 'Fan Favorite',
  moodMatch:
  'Edge-of-your-seat tension and stylish visuals \u2014 perfect when you want your pulse racing.'
}];
export const MOVIES_COUNT = MOVIES.length;

export function Result({ onReset, isSurprise = false, surpriseIndex = 0 }: {onReset: () => void; isSurprise?: boolean; surpriseIndex?: number;}) {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[210px_1fr_230px] gap-6 lg:gap-8 flex-1 min-h-0">
            ...
            <motion.div
              ...
              <div className="grid grid-cols-2 gap-8 mt-6">
                <div>
                  ...
                  <p className="font-medium text-slate-900">{movie.director}</p>
                </div>
                <div>
                  <h3 className="text-xs font-bold text-crimson tracking-widest mb-1">
                    CINEMATOGRAPHY
        ...
        <div className="flex flex-col gap-5">
          <div className="bg-slate-50 rounded-2xl p-5 border border-slate-100">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex justify-between pb-1">
                ...
                <span className="font-bold text-crimson">{movie.status}</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-50 rounded-2xl p-5 border border-slate-100">
            ...
            {/* Not feeling it? — centered overlay modal */}
            <div className="mt-5">
              <button
            ...
            <AnimatePresence>
              ...
              <motion.div
                ...
                {/* Soft white backdrop — matches blush page feel */}
                <div
